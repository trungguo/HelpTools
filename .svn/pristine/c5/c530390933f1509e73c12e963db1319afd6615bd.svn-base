    ...
    public class FBAccountConfigController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            try
            {
                ...
                ViewBag.Albums = AlbumService.GetAll(Builders<BsonDocument>.Filter.Eq("OrgCode", org.Id), Builders<BsonDocument>.Sort.Ascending("Code").Ascending("Name"));
            ...
            try
            {
                ...
                if (model.Items != null)
                {
                    model.Items.ForEach(t =>
                    {
                        ...
                        var album = AlbumService.FindOne(t.Reel.AlbumId);
                        if (album != null)
                        {
                            t.Reel.Album = album.Code;
                            t.Reel.VideoDescriptions = album.VideoDescriptions;
                        }
                    });
                }
